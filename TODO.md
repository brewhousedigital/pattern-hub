...
- Finished soft delete for patterns
- New database for Pattern Key Reference Images
- New column in the Patterns table to support N-number of pattern reference keys
- New column in the Patterns table to support instructions. Set to 10k characters but can update if needed
- Made the admin Pattern Edit modal larger
- Added Pattern Key Management to admin permissions control
- Added character count to FAQ
