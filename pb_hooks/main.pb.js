...
routerAdd('POST', '/api/sync-aggregates', (c) => {
  try {
    ...
    const ratingsMap = {};
    $app.findRecordsByFilter('community_ratings', "id != ''", '', 0, 0).forEach((r) => {
    ...
    const diffMap = {};
    $app.findRecordsByFilter('community_difficulty_ratings', "id != ''", '', 0, 0).forEach((r) => {
    ...
    const favMap = {};
    $app.findRecordsByFilter('user_favorites', "id != ''", '', 0, 0).forEach((r) => {
