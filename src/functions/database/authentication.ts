...
export const EnumLevelsAdmin = {
  ...
  SETS_AU: 'SETS_AU',
  SETS_AD: 'SETS_AD',
  MANUAL_AUTHOR_AC: 'MANUAL_AUTHOR_AC',
  MANUAL_AUTHOR_AR: 'MANUAL_AUTHOR_AR',
  MANUAL_AUTHOR_AU: 'MANUAL_AUTHOR_AU',
  MANUAL_AUTHOR_AD: 'MANUAL_AUTHOR_AD',
  USER_SUBMIT_AC: 'USER_SUBMIT_AC',
  USER_SUBMIT_AR: 'USER_SUBMIT_AR',
  USER_SUBMIT_AU: 'USER_SUBMIT_AU',
  USER_SUBMIT_AD: 'USER_SUBMIT_AD',
