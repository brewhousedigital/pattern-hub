/**
 * Canonical normalization rule for a tag name. Every place that stores or
 * compares a tag string must run it through this function first. This stops
 * two admins, or an admin and a public submitter, from creating two
 * different rows for the same tag.
 *
 ...
 * source of truth for the canonical rule. Use it for any backfill script
 * and every tag entry point.
 *
